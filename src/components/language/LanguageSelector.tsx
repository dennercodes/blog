...
export function LanguageSelector() {
  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger className="inline-flex h-9 w-[52px] items-center justify-center rounded-md bg-button-secondary-bg text-button-secondary-text hover:bg-button-hover">
        {t(`languages.${locale}`)}
